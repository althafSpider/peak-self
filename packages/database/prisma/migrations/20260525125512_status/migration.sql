/*
  ...
  - The values [GENERATED,FINALIZED,FAILED] on the enum `GeneratedPlanStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "GeneratedPlanStatus_new" AS ENUM ('PENDING', 'QUESTIONS_GENERATING', 'QUESTIONS_FAILED', 'QUESTIONS_READY', 'ANSWERS_PENDING', 'PLAN_GENERATING', 'PLAN_GENERATED', 'PLAN_FINALIZED', 'PLAN_FAILED');

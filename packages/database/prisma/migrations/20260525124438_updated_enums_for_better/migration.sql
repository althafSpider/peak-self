/*
  ...
  - The values [GENERATING,AI_QUESTIONS_GENERATING,AI_QUESTIONS_GENERATED] on the enum `GeneratedPlanStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "GeneratedPlanStatus_new" AS ENUM ('PENDING', 'QUESTIONS_GENERATING', 'QUESTIONS_READY', 'ANSWERS_PENDING', 'PLAN_GENERATING', 'GENERATED', 'FINALIZED', 'FAILED');
